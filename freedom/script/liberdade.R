...
# WordCloud for street names

set.seed(1234) # for reproducibility 
wordcloud2(data=freedom_roads[,1:2], size=3, color='random-light', backgroundColor="black")
saveWidget(test,"tmp.html",selfcontained = F)

# Wordcloud for Tweets

set.seed(1234) # for reproducibility 
wordcloud2(data=d, size=3, color='random-light', backgroundColor="black")

# How important is freedom for Portugal?
